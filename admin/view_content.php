   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="Hapus" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">Belum ada video! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah videos</a></p>';
   }
