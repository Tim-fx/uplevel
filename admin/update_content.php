...
<section class="video-form">
   ...
   <h1 class="heading">Perbarui Video</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         ...
         <option value="deactive">Mati</option>
      </select>
      <p>Judul <span>*</span></p>
      ...
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--pilih materi</option>
         <?php
      ...
      <input type="submit" value="Perbarui Video" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Lihat Video</a>
         <input type="submit" value="Hapus Video" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Video tidak ditemukan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah Video</a></p>';
      }
   ?>
