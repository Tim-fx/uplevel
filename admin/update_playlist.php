...
<section class="playlist-form">
   ...
   <h1 class="heading">Perbarui Materi</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         <input type="submit" value="Hapus" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Lihat Materi</a>
      </div>
   </form>
   <?php
      } 
