   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Perbarui Materi</a>
            <input type="submit" value="Hapus Materi" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         </form>
      </div>
   </div>
   <?php
...
<section class="contents">
   ...
   <h1 class="heading">Materi Video</h1>
   ...
   <?php
         ...
         echo '<p class="empty">Belum ada video yang dimasukan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah Video</a></p>';
      }
   ?>
