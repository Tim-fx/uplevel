...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         ...
         <a href="add_playlist.php" class="btn">tambah materi baru</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Perbarui</a>
            <input type="submit" value="Hapus" class="delete-btn" onclick="return confirm('Hapus materi?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Lihat Materi</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">belum menambahkan materi!</p>';
      }
      ?>
